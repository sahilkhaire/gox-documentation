...
<SymbolHeader pkg="time" title="LayoutTime" node="moment, dayjs (package timex)" import-path="github.com/sahilkhaire/gox/time" />
## Overview
...
formatted := timex.Format(t, timex.LayoutTime)
```
