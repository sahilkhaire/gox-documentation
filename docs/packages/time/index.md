...
<tr><td><a href="/packages/time/format">Format</a></td><td><code class="node-cell">moment().format()</code></td><td><span class="kind-pill">func</span></td><td></td></tr>
...
<tr><td><a href="/packages/time/parse-duration">ParseDuration</a></td><td><code class="node-cell">ms('2d')</code></td><td><span class="kind-pill">func</span></td><td></td></tr>
