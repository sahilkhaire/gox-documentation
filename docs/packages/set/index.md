...
<tr><td><a href="/packages/set/set-new">Set.New</a></td><td><code class="node-cell">new Set(arr)</code></td><td><span class="kind-pill">method</span></td><td>New creates a set from items.</td></tr>
