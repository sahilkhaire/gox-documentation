...
<table class="symbol-table"><thead><tr><th>Symbol</th><th>Node.js</th><th>Kind</th><th>Summary</th></tr></thead><tbody>
<tr><td><a href="/packages/redis/client-new">Client.New</a></td><td><code class="node-cell">new Redis()</code></td><td><span class="kind-pill">method</span></td><td>New connects to addr (host:port).</td></tr>
