...
<table class="symbol-table"><thead><tr><th>Symbol</th><th>Node.js</th><th>Kind</th><th>Summary</th></tr></thead><tbody>
<tr><td><a href="/packages/mongo/client-connect">Client.Connect</a></td><td><code class="node-cell">mongoose.connect(uri)</code></td><td><span class="kind-pill">method</span></td><td>Connect dials uri.</td></tr>
</tbody></table>
