...
<tr><td><a href="/packages/json/parse">Parse</a></td><td><code class="node-cell">JSON.parse(str)</code></td><td><span class="kind-pill">func</span></td><td>Parse unmarshals data into v (JSON.parse).</td></tr>
...
<tr><td><a href="/packages/json/stringify">Stringify</a></td><td><code class="node-cell">JSON.stringify(obj)</code></td><td><span class="kind-pill">func</span></td><td>Stringify marshals v to a string (JSON.stringify).</td></tr>
